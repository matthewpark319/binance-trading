...
class SignalCalculator:
	...
	def load_price_data(self, coin_id):
		query = "select * from " \
			...
			"order by timestamp desc limit 250) as x " \
	...
	def signals(self):
		...
		# Third, calculate the RSI signals
		for _range in self.rsi_ranges:
